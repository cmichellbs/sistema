...
class Contract (models.Model):
    contract_number = models.CharField(max_length=300,null=False,blank=False,verbose_name='Número de contrato',help_text='Número de contrato',)
    ...
    amortization_type = models.ForeignKey(AmortizationType,verbose_name="Tipo de amortização",on_delete=models.SET_NULL,null=True,blank=True,help_text='Tipo de amortização',)
    interest_rate = models.DecimalField(max_digits=5,decimal_places=2,null=False,blank=False,verbose_name='Taxa de juros',help_text='Taxa de juros',)
    ...
    contract_bcb_sgs_code = models.IntegerField(null=True,blank=True,verbose_name='Código BCB SGS',help_text='Código BCB SGS',)
